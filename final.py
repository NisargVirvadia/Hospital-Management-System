...
# tkinter window
    ...
    def add_appointment(self):
        ...
        self.add = Button(text="ADD APPOINTMENT", width=20, height=2, bg='steelblue',command="addapp")
        self.add.place(x=300, y=340)

        self.submit = Button(text="UPDATE APPOINTMENT", width=20, height=2, bg='steelblue',command="update")
        self.submit.place(x=500, y=340)

        self.submit = Button(text="DISPLAY APPOINTMENT", width=20, height=2, bg='steelblue',command="display")
